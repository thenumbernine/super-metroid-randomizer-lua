...
local formatsAndSizesInfo = {
	{	-- Absolute
		...
		instrs = {
			-- Stack (Pull)
			0x28, 0x2B, 0x68, 0x7A, 0xAB, 0xFA,
			-- Stack (Push)
			0x08, 0x0B, 0x48, 0x4B, 0x5A, 0x8B, 0xDA,
			-- Stack (RTL)
			0x6B,
			-- Stack (RTS)
			0x60,
			...
			0x40,
			-- Implied
			0x18, 0x1B, 0x38, 0x3B, 0x58, 0x5B, 0x78, 0x7B, 0x88, 0x8A, 0x98, 0x9A, 0x9B, 0xA8, 0xAA, 0xB8, 0xBA, 0xBB, 0xC8, 0xCA, 0xCB, 0xD8, 0xDB, 0xE8, 0xEA, 0xEB, 0xF8, 0xFB
		},
