...
function Patches:skipIntro()
	ffi.copy(self.rom + 0x016eda, hexStrToByteArray'1f')
	ffi.copy(self.rom + 0x010067, hexStrToByteArray'2200ff80')
	ffi.copy(self.rom + 0x007f00, hexStrToByteArray'af98097ec91f00d024afe2d77ed01eafb6d87e0904008fb6d87eafb2d87e0901008fb2d87eaf52097e22008081a900006b')
end
...
--]]	
	...
	ffi.copy(rom + topc(0x8f, wakeZebesEarlyDoorCode), data, ffi.sizeof(data))
